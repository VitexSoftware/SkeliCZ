...
class PageBottom extends \Ease\TWB\Container
{
    ...
    public function finalize()
    {
        ...
        $footrow->addColumn(4,
            '<iframe src="https://ghbtns.com/github-btn.html?user=VitexSoftware&repo=SkeliCZ&type=star&count=true" frameborder="0" scrolling="0" width="170px" height="20px"></iframe>')->addItem(new FBLike());
        ...
        $footrow->addColumn(4,
            '&copy; 2016 Radek "Skeli" Dvořák<br/> Powered by <a href="https://www.vitexsoftware.cz/ease.php">Ease Framework</a>');
